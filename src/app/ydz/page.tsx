...
const AdminPage: React.FC = (props) => {
  ...
  const { data, isLoading, isValidating, error, mutate } = useSWR<UserListResponse>("https://api.haitunx.com/api/app/haitun/user/personList", fetcher, {
  ...
  const handleOperation = (subsDay: number) => {
    fetch("https://api.haitunx.com/api/app/haitun/user/addSubstime", {
      method: "POST",
      headers: {
