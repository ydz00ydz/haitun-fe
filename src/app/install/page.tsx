  ...
  return (
    <div className="flex flex-col justify-center items-center h-full p-16">
      <div className="px-16 w-3/4 flex flex-col justify-center leading-loose">
        <p className="text-3xl font-bold text-center mb-8">海豚插件安装教程</p>
        <p>以下是安装 Chrome 或 Edge 的插件的简单指南，咱们一起来搞定它吧！💪</p>
        <p>1️⃣ 首先，你需要下载插件的离线安装文件 haitun.zip，解压成文件包</p>
        <a href="/download/haitun.zip" className="h-12 rounded-[12px] py-2 px-8 my-4 mx-auto text-white bg-green-500 max-w-60 align-center">
          下载插件
        </a>
        <p>1️⃣ 压缩包解压成文件夹</p>
        <img src="/img/crx-1.png" alt="解压文件包" className="w-full my-4" />
        <p>
          2️⃣ 打开 Chrome 或 Edge 浏览器，进入浏览器设置。在 Chrome 浏览器中，你可以在右上角点击菜单图标，选择“更多工具”，再选择“扩展程序”。在 Edge
          浏览器中，点击右上角菜单图标，选择“扩展”
        </p>
        <p>3️⃣ 在扩展程序页面，打开“开发者模式”。在 Chrome 浏览器中，你需要在右上角开启开发者模式，而在 Edge 浏览器中，该选项位于扩展程序页面的左下角</p>
        <p>4️⃣ 点击 “加载已解压的扩展程序” 选择将解压好的文件包</p>
        <img src="/img/crx-2.png" alt="解压文件包" className="w-full my-4" />
        <p>5️⃣ 会弹出一个提示框，点击“添加扩展程序”进行安装</p>
        <p>6️⃣ 如果该插件需要特殊的权限，你需要在弹出的窗口中确认授权。此时插件已经成功安装了</p>
